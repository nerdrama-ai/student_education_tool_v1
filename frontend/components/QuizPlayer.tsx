          ...
          {(q?.options || q?.choices || []).map((opt: any, i: number) => (
            <button
              ...
              className={
                ...
                (selected === i
                  ? "ring-2 ring-indigo-400 bg-white/4"
                  : "bg-white/2")
              }
            >
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="w-2/3">
            <div className="progress-track">
              <div
                className="progress-fill bg-gradient-to-r from-purple-500 to-cyan-400"
                style={{ width: `${progress}%` }}
              ></div>
            </div>
          </div>
          <div className="flex gap-2">
            <button className="btn-fut glass" onClick={prev}>
              Prev
            </button>
            <button className="btn-fut glass" onClick={next}>
              Next
            </button>
          </div>
        </div>
